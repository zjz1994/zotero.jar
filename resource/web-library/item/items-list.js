	...
	_createClass(ItemsList, [{
		...
		value: function render() {
			...
			if (this.props.isFetching) {
				...
				'table',
				{ className: 'item-list-head hidden-touch hidden-sm-down' },
				_react2.default.createElement(
				'thead',
				null,
				_react2.default.createElement(
				...
				_react2.default.createElement('th', { className: 'hidden-touch hidden-sm-down' }),
				_react2.default.createElement('th', { className: 'hidden-touch hidden-sm-down' })))),
				...
				this.props.items.map(function (item) {
					return _react2.default.createElement(_item2.default, {
						onClick: function onClick() {
							return _this2.props.onItemSelected(item.key);
						},
						active: item.key === _this2.props.selectedItemKey,
						key: item.key,
						item: item });
				}))));
